...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <ul>
        ...
        <li class="f"><a href="consultaPrestamosQuimicos.php" style="color: yellowgreen; font-family: 'Pacifico', cursive; font-size: 1.3rem;"  class="active">Prestamos Activos</a></li>
...
<table id="tablax" class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="select distinct alumno from tbprestamosquimi";
        $query2="select * from tbprestamosquimi";
       ...
       <tr>
         ...
         <div class="col mb-2">
            <a class="oculto" style="color: blue;" href="editarPrestarQuimico.php?alumno=<?php echo $row['alumno']; ?>"><img src=imagenes/editar.png>  Editar</a><br>
         </div>
        <div>
            <a class="oculto "style="color: green;" href="completarTprestamoquimi.php?alumno=<?php echo $row['alumno']; ?>"><img src=imagenes/cheque.png>  Entregado</a></td>
        </div> 
